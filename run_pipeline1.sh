...
#singularity run conda.simg python /scratch/AG_Preibisch/Ella/embryo/nd2totif_maskembryos_stagebin_pipeline/stardist_predict.py 2>&1 |  tee -a /scratch/AG_Preibisch/Ella/embryo/nd2totif_maskembryos_stagebin_pipeline/pipeline.log
