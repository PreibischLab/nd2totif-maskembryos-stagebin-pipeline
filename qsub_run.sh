...
~/Fiji.app/ImageJ-linux64 --mem=10G --headless --run 2_fix_tif_metadata_imagej_to_have_channels.ijm 2>&1 | tee -a pipeline.log
singularity run conda.simg python 3_stardist_predict.py  2>&1 |  tee -a pipeline.log
